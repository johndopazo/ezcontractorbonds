...
// Check for environment variables and use those. This is currently
...
/* When moving site or testing locally you might need to override the site
 * url that's in the database. You can set an environment variable for 'URL'. */
if (getenv('URL')) {
